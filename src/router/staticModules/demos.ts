    ...
    children: [
      {
        ...
        meta: {
          title: t('routes.api.interfaceSetting'),
          icon: 'icon-zhuomian',
        },
        component: import(
          /* webpackChunkName: "demos-custom-a-custom-modal" */ '@/views/xianrenAPI/ApiSetting.vue'
        ),
      },
      {
        path: '/InterfaceAdd',
        name: `InterfaceAdd`,
        meta: {
          title: t('routes.api.interfaceAdd'),
          icon: 'icon-zhuomian',
        },
        component: import(
          /* webpackChunkName: "demos-custom-a-custom-modal" */ '@/views/xianrenAPI/ApiAdd.vue'
        ),
      },
    ]
